...
%BCOR=3cm,          % Bundsteg (binding correction) only relevant for printing
...
\usepackage[
    ...
    pdfcreator={},
    pdfkeywords={},
    pdfproducer={LaTeX (Template created by Felix Siegfried Riedel. GitHub: https://github.com/FelixSiegfriedRiedel/htw-thesis-template)},
    hidelinks]{hyperref}
